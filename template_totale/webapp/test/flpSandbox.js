		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Template_totale_finale",
									"targetURL": "#templatetotale-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"templatetotale-display": {
								"semanticObject": "templatetotale",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=templatetotale",
									"url": sap.ui.require.toUrl("templatetotale")
								}
							}
						}
					}
